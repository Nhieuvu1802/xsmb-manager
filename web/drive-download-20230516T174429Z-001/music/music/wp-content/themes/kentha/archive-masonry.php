...
<div id="maincontent">
	<div class="qt-main qt-clearfix qt-3dfx-content">
		...
		<div id="qtarticle" class="qt-container qt-main-contents qt-main-contents-masonry">
			...
			<div id="qtloop" class="row qt-masonry">
				<?php 
				if(is_page()){
					/**
					...
					if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) : $wp_query->the_post();
						$post = $wp_query->post;
						setup_postdata( $post );
						?><div class="col s12 m6 l4 qt-ms-item"><?php 
						get_template_part ('phpincludes/part-archive-item-masonry');
						?></div><?php  
					endwhile; else: ?>
