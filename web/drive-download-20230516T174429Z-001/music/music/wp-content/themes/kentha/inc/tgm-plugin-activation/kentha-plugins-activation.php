 ...
 * 
 */
if(!function_exists( 'kentha_deactivate_plugin_conditional' ) && function_exists( 't2gconnectorclient_register_my_custom_menu_page' )){
	add_action( 'admin_init', 'kentha_deactivate_plugin_conditional' );
	function kentha_deactivate_plugin_conditional() {
